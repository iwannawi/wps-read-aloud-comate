...
本项目未修改上述模型文件，仅作为离线运行资源随安装包分发到本项目专用语音模型目录。

| CPU 架构 + 操作系统 | 模型目录 |
| --- | --- |
| x86/x64 Windows 10/11 | 安装目录下的 voices\sherpa |
| x64 银河麒麟系统 | /opt/wps-read-aloud-comate/voices/sherpa |
| ARM64 银河麒麟系统 | /opt/wps-read-aloud-comate/voices/sherpa |
| x64 UOS系统 | /opt/apps/cn.wps-read-aloud-comate/files/voices/sherpa |
| ARM64 UOS系统 | /opt/apps/cn.wps-read-aloud-comate/files/voices/sherpa |
