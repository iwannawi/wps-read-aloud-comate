...
| --- | --- | --- |
| x86/x64 Windows 10/11 | WPS Office 2019 或更高版本 | wps-read-aloud-comate_1.2.0_windows.exe |
| x64 银河麒麟系统 | WPS Office 2019 for Linux 或更高版本 | wps-read-aloud-comate_1.2.0_amd64.deb |
| ARM64 银河麒麟系统 | WPS Office 2019 for Linux 或更高版本 | wps-read-aloud-comate_1.2.0_arm64.deb |
| x64 UOS系统 | WPS Office 2019 for Linux 或更高版本 | cn.wps-read-aloud-comate_1.2.0_amd64.deb |
| ARM64 UOS系统 | WPS Office 2019 for Linux 或更高版本 | cn.wps-read-aloud-comate_1.2.0_arm64.deb |

## 安装验收

| CPU 架构 + 操作系统 | 操作 |
| --- | --- |
| x86/x64 Windows 10/11 | 运行 wps-read-aloud-comate_1.2.0_windows.exe |
| x64 银河麒麟系统 | sudo dpkg -i wps-read-aloud-comate_1.2.0_amd64.deb |
| ARM64 银河麒麟系统 | sudo dpkg -i wps-read-aloud-comate_1.2.0_arm64.deb |
| x64 UOS系统 | sudo dpkg -i cn.wps-read-aloud-comate_1.2.0_amd64.deb |
| ARM64 UOS系统 | sudo dpkg -i cn.wps-read-aloud-comate_1.2.0_arm64.deb |
...
- Windows 开始菜单存在“WPS文档朗读助手”文件夹，文件夹内至少包含“打开安装目录”和“卸载 WPS文档朗读助手”两个入口；卸载入口使用 Windows 系统卸载图标；系统“应用和功能”中存在本软件卸载项。
...
| 验收项 | x86/x64 Windows 10/11 | x64/ARM64 银河麒麟系统 | x64/ARM64 UOS系统 |
| --- | --- | --- | --- |
...
- 开始菜单“WPS文档朗读助手”目录下应有“打开安装目录”和“卸载 WPS文档朗读助手”两个入口，避免 Windows 11 将单快捷方式文件夹扁平化显示；卸载入口不使用本软件 logo，使用 Windows 系统卸载图标。
...
示例文本：
    ...
    这是 WPS 2026 read aloud test，版本是 v1.2.0。
